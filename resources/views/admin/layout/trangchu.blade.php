...
@section('body')	
			...
			<div class="row anhbanner" style="width: 1550px">
				...
				<div class="col-md-12 banner">
					<h3 class="dream">KEEP DREAMING</h3>
					<div class="up">
						<h2 class="online">Best Online Exam</h2>
					<h2 class="training">Training Exam</h2>
					</div>
					<p class="canbtn">
						<a href="trangchu"><span class="view">VIEW MORE</span></a>
						<a href="trangchu"><span class="thamgia">JOIN EXAM</span></a>
					</p>
				</div>
			</div>
				...
				<div class="col-md-12">
						<div class="thanh_menu">
							<ul class="nav nav-tabs ">
							    <li class="active thpt1"><a data-toggle="tab" class="kythi" id="THPT" href="#home">Đại cương</a></li>
							    <li class="thpt2"><a data-toggle="tab" class="kt1" href="#menu1">Chuyên ngành</a></li>
