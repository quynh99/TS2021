...
<body>
	...
	@endforeach
	<div class="quaylai" style="text-align:center; margin:20px"><a href="{{url('trangchu')}}" style="padding:10px 15px; background-color:#ed5747"><span style="color:black; font-size:20px">Trang chủ</span></a><div>
